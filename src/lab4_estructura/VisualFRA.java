 ...
 * @author Dell
 */
public class VisualFRA extends JFrame {
    ...
    public VisualFRA() {
        ...
        azar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                    ...
                    VisualFRA.this.setVisible(false);
            }
        });
        ...
        fijas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                palabraIngresada = JOptionPane.showInputDialog(VisualFRA.this, "Ingresa una palabra:");
                ...
                if (palabraIngresada != null && !palabraIngresada.trim().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(VisualFRA.this, "No ingresaste ninguna palabra.", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
